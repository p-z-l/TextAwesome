...
class CodeHighlighter {
    ...
    static func highlight(_ attributedString: NSAttributedString, fileExtension: String) -> NSAttributedString {
        ...
        func scan(dictID: String, color: UIColor) {
            ...
            let ranges = Utils.findNSRangeOfMultiplePatterns(string: string, patterns: dict, caseSensitive: true)
            for range in ranges {
